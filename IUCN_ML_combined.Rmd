...
animals <- read_excel("~/Desktop/Internship/meta_r.xls")
...
animals$popstability <- as.factor(animals$popstability)
animals$movement <- as.factor(animals$movement)
...
vip(rf_animals, num_features = 10, geom = "point", horizontal = FALSE,
aesthetics = list(color = "green", shape = 17, size = 7)) +
xlab("Model features")+ ggtitle("Model Feature Importance")+
theme_light()
