...
data.imputed <- rfImpute(threat~., data = animals, iter=6) #everything needs to be a factor 
...
```
##Out of Bag## --> checks the accuracy of the model 
...
set.seed(42) #set seed so model outcome is repeatable
...
#Multidimensional Scaling Plot (same as PCoA)
